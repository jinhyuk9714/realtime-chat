...
원본 README 기준으로 REST API 처리량은 **RPS 70% 증가**, p50 latency는 **69% 감소**했고, WebSocket 부하 테스트에서는 **동시 WebSocket 1,158 세션**을 확인했습니다. 상세 수치는 [docs/PERF_RESULT.md](docs/PERF_RESULT.md)에 정리되어 있습니다.
